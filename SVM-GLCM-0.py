...
def train(parent):
    ...
    for folder in os.listdir(parent):
        ...
        np.savetxt("SVM-GLCM_train_feature.csv", train_feature, delimiter=",")
        np.savetxt("SVM-GLCM_train_label.csv", train_label, delimiter=",")
...
def test(parent):
    ...
    for folder in os.listdir(parent):
        ...
        np.savetxt("SVM-GLCM_test_feature.csv", test_feature, delimiter=",")
        np.savetxt("SVM-GLCM_test_label.csv", test_label, delimiter=",")
